...
<Cite paperId="wei2011parallel" /> introduces a GPU-optimized Expectation
Maximization algorithm for clustering large-scale point data. Although this
method is able to establish a great seed for reaching some local optimum,
expert-led clustering is expected to achieve a better clustering
<Cite paperId="rsos.211189" />. This paper will focus on creating better tools
for experts to cluster the data in a more effective way.
