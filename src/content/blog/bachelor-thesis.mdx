...
<Image src="/blogs/bachelor-thesis/Marker Distribution for Thesis.png" map={map} alt="new marker dist" label="new marker dist" width={839} height={751} class="rounded" >This figure shows an example of a lattice with L = 3 and D = 3. 
